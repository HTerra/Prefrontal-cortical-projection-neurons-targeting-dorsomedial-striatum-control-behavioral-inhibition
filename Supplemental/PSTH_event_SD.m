function [psthBinsValue, PSTH, TrialDistr] = PSTH_event_SD(All, neuronIndex, parameters_OI, neuron, binSize, event, InfoDist, varargin)
...
%                         end
                ...
                axis([-TrialStart_tBef TrialStart_tAft 1 numel(TrialDistr.CorTresholdIncluded)+numel(TrialDistr.IncTresholdIncluded)+numel(TrialDistr.OmTresholdIncluded)+numel(TrialDistr.PremTresholdIncluded)])
                ylabel('Trial')
                ...
                axis([-Treshold_tBef Treshold_tAft 1 numel(TrialDistr.CorTresholdIncluded)+numel(TrialDistr.IncTresholdIncluded)+numel(TrialDistr.OmTresholdIncluded)+numel(TrialDistr.PremTresholdIncluded)])
                ylabel('Trial')
                ...
                axis([-Response_tBef Response_tAft 1 numel(TrialDistr.CorTresholdIncluded)+numel(TrialDistr.IncTresholdIncluded)+numel(TrialDistr.OmTresholdIncluded)+numel(TrialDistr.PremTresholdIncluded)])
                ylabel('Trial')
