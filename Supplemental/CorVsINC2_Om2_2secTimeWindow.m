function CorVsINC2_Om2_2secTimeWindow(All,neuronIndex, SD_All, SD_All, SD_OI, SD_OI, SDperiod)
...
%             h2(i) = lillietest(mean(PSTH_Inc_All{1, VAR_SDixOIMatched(i)}(:,timeBins{t}),2)); 
%             if h1(i) == 0 & h2(i) == 0
...
for t = [1 2 3]
    for Cl = 1:numel(ClustUpMidDown)
        subplot(3,3,pos(n))
        hold on
        scatter(CorFR.OI.(trialTypo2{t})(find(Sign.SD_OI.(trialTypo2{t})(1,:)>=0.05&SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))),IncFR.OI.(trialTypo2{t})(find(Sign.SD_OI.(trialTypo2{t})(1,:)>=0.05&SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))),'r')
        scatter(CorFR.OI.(trialTypo2{t})(find(Sign.SD_OI.(trialTypo2{t})(1,:)<0.05&SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))),IncFR.OI.(trialTypo2{t})(find(Sign.SD_OI.(trialTypo2{t})(1,:)<0.05&SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))),'r','filled')
        %lsline
        scatter(CorFR.All.(trialTypo2{t})(find(Sign.SD_All.(trialTypo2{t})(1,:)<0.05&SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))),IncFR.All.(trialTypo2{t})(find(Sign.SD_All.(trialTypo2{t})(1,:)<0.05&SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))),'b','filled')
        scatter(CorFR.All.(trialTypo2{t})(find(Sign.SD_All.(trialTypo2{t})(1,:)>=0.05&SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))),IncFR.All.(trialTypo2{t})(find(Sign.SD_All.(trialTypo2{t})(1,:)>=0.05&SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))),'b')
        m = max([CorFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))) IncFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))) CorFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))) IncFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl)))]);
        m2 = min([CorFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))) IncFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))) CorFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))) IncFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl)))]);
        [R P] = corrcoef(CorFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))),IncFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))));
        R_OI(n) = R(2);
        R_P_OI(n) = P(2);
        [R P] = corrcoef(CorFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))),IncFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))));
        R_All(n) = R(2);
        R_P_All(n) = P(2);
        line([m2 m],[m2 m])
        xlim([m2 m])
...
for t = [1 2 3]
        for Cl = 1:numel(ClustUpMidDown)
            ...
            %diffCorInc.OI2.(trialTypo2{t}){Cl} = ((OmFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl)))'-CorFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl)))')./(CorFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl)))'))*100;

            try
            CorVsIncSign.OI.(trialTypo2{t})(Cl) = signrank(CorFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))),IncFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'==ClustUpMidDown(Cl))));
        ...
        subplot(3,1,pos(n))
        bar(diffCorInc.OI.(trialTypo2{t}))
        ylim([-25 25])
        n = n+1;
        %CorVsOmSign.OI.(trialTypo2{t}) = mafdr([CorVsOmSign.OI.(trialTypo2{t})],'BHFDR',true);
        CorVsIncSign_Combined.OI.(trialTypo2{t}) = signrank(abs(CorFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'~=ClustUpMidDown(2)))),abs(IncFR.OI.(trialTypo2{t})(find(SD_OI_clust.(trialTypo2{t})'~=ClustUpMidDown(2)))));
...
for t = [1 2 3]
        for Cl = 1:numel(ClustUpMidDown)
            ...
            %ylabel('Firing rate (Hz)')
            diffCorInc.All.(trialTypo2{t})(Cl) = median(((IncFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl)))'-CorFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl)))')./abs((CorFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl)))')))*100);
            ...
            h2(i) = lillietest(IncFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl)))); 
            if h1(i) == 0 & h2(i) == 0
                try
                [h CorVsIncSign.All.(trialTypo2{t})(Cl)] = ttest(CorFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))),IncFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))),'Vartype','unequal');
                %CorVsOmSign.AllVal.(trialTypo2{t}){Cl} = abs(CorFR.All.(trialTypo2{t})(find(Sign.SD_All.(trialTypo2{t}) < 0.05))-OmFR.All.(trialTypo2{t})(find(Sign.SD_All.(trialTypo2{t}) < 0.05)));
                    ...
                    CorVsIncSign.All.(trialTypo2{t})(Cl) = nan;
                end
            else
                try
                CorVsIncSign.All.(trialTypo2{t})(Cl) = signrank(CorFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))),IncFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'==ClustUpMidDown(Cl))));
                %CorVsOmSign.AllVal.(trialTypo2{t}){Cl} = abs(CorFR.All.(trialTypo2{t})(find(Sign.SD_All.(trialTypo2{t}) < 0.05))-OmFR.All.(trialTypo2{t})(find(Sign.SD_All.(trialTypo2{t}) < 0.05)));
        ...
        subplot(3,1,pos(n))
        bar(diffCorInc.All.(trialTypo2{t}))
        ylim([-25 25])
        n = n+1;
        CorVsIncSign.All.(trialTypo2{t}) = mafdr([CorVsIncSign.All.(trialTypo2{t})],'BHFDR',true);
        CorVsIncSign_Combined.All.(trialTypo2{t}) = signrank(abs(CorFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'~=ClustUpMidDown(2)))),abs(IncFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'~=ClustUpMidDown(2)))));
        CorVsIncSign_Combined2.All.(trialTypo2{t}){2} = abs(CorFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'~=ClustUpMidDown(2))));
        CorVsIncSign_Combined2.All.(trialTypo2{t}){3} = abs(IncFR.All.(trialTypo2{t})(find(SD_All_clust.(trialTypo2{t})(VAR_SDixOIMatched)'~=ClustUpMidDown(2))));
end
CorVsIncSign_Combined.All_combined = mafdr([CorVsIncSign_Combined.All.TH CorVsIncSign_Combined.All.Cue],'BHFDR',true);
figure
subplot(1,3,1)
hold on
plot([CorVsIncSign_Combined2.All.TS{1, 2}; CorVsIncSign_Combined2.All.TS{1, 3}],'k')
boxplot([CorVsIncSign_Combined2.All.TS{1, 2}' CorVsIncSign_Combined2.All.TS{1, 3}'],'Labels',{'Correct','Omature'})
ylabel('Absolute delta FR (Hz)')
ylim([0 25])
subplot(1,3,2)
hold on
plot([CorVsIncSign_Combined2.All.TH{1, 2}; CorVsIncSign_Combined2.All.TH{1, 3}],'k')
boxplot([CorVsIncSign_Combined2.All.TH{1, 2}' CorVsIncSign_Combined2.All.TH{1, 3}'],'Labels',{'Correct','Incature'})
ylabel('Absolute delta FR (Hz)')
ylim([0 25])
subplot(1,3,3)
hold on
plot([CorVsIncSign_Combined2.All.Cue{1, 2}; CorVsIncSign_Combined2.All.Cue{1, 3}],'k')
boxplot([CorVsIncSign_Combined2.All.Cue{1, 2}' CorVsIncSign_Combined2.All.Cue{1, 3}'],'Labels',{'Correct','Incature'})
ylabel('Absolute delta FR (Hz)')
ylim([0 25])
...
for n = 1:size(SD_OI.(SDperiod).psthBinsValue,2)
    ...
    OI_PSTH.PSTH.TS.Inc(n,:) = (mean(SD_OI.(SDperiod).psthBinsValue{1, n}.Inc.trial_start(:,1:45)/binSize,1)-mean(mean(SD_OI.(SDperiod).psthBinsValue{1, n}.Cor.trial_start(:,1:10)/binSize,1)));%/std(mean(SD_OI.(SDperiod).psthBinsValue{1, n}.Om.trial_start(:,1:10)/binSize,1));%/max(abs(mean(SD_OI.(SDperiod).psthBinsValue{1, n}.Cor.trial_start(:,11:15),1)));
    OI_PSTH.PSTH.TH.Inc(n,:) = (mean(SD_OI.(SDperiod).psthBinsValue{1, n}.Inc.wait_start(:,1:25)/binSize,1)-mean(mean(SD_OI.(SDperiod).psthBinsValue{1, n}.Cor.trial_start(:,1:10)/binSize,1)));%/std(mean(SD_OI.(SDperiod).psthBinsValue{1, n}.Om.trial_start(:,1:10)/binSize,1));%/max(abs(mean(SD_OI.(SDperiod).psthBinsValue{1, n}.Cor.wait_start(:,6:25),1)));
...
for n = 1:size(SD_All.(SDperiod).psthBinsValue,2)
    ...
    All_PSTH.PSTH.TS.Inc(n,:) = (mean(SD_All.(SDperiod).psthBinsValue{1, n}.Inc.trial_start(:,1:45)/binSize,1)-mean(mean(SD_All.(SDperiod).psthBinsValue{1, n}.Cor.trial_start(:,1:10)/binSize,1)));%/std(mean(SD_All.(SDperiod).psthBinsValue{1, n}.Inc.trial_start(:,1:10)/binSize,1));%/max(abs(mean(SD_OI.(SDperiod).psthBinsValue{1, n}.Cor.trial_start(:,11:15),1)));
    All_PSTH.PSTH.TH.Inc(n,:) = (mean(SD_All.(SDperiod).psthBinsValue{1, n}.Inc.wait_start(:,1:25)/binSize,1)-mean(mean(SD_All.(SDperiod).psthBinsValue{1, n}.Cor.trial_start(:,1:10)/binSize,1)));%/std(mean(SD_All.(SDperiod).psthBinsValue{1, n}.Inc.trial_start(:,1:10)/binSize,1));%/max(abs(mean(SD_OI.(SDperiod).psthBinsValue{1, n}.Cor.wait_start(:,6:25),1)));
    %All_PSTH.PSTH.cue_bef.Inc(n,:) = (mean(SD_All.(SDperiod).psthBinsValue{1, n}.Inc.cue(:,1:30)/binSize,1)-mean(mean(SD_All.(SDperiod).psthBinsValue{1, n}.Cor.trial_start(:,1:10)/binSize,1)));%/std(mean(SD_All.(SDperiod).psthBinsValue{1, n}.Inc.trial_start(:,1:10)/binSize,1));%/max(abs(mean(SD_OI.(SDperiod).psthBinsValue{1, n}.Inc.cue(:,1:10),1)));
end
...
% subplot(2,3,4)
% colormap('jet')
% imagesc(time_axis_TS,1:(size(OI_PSTH.PSTH.TS.Inc,1)),OI_PSTH.PSTH.TS.Inc(I,1:45))
% axis([-2-(0.5*binSize) 7+(0.5*binSize) 0.5 size(OI_PSTH.PSTH.TS.Inc,1)+0.5])
% ylabel('Neuron')
% caxis(axisRange)
% title('Trial start')
...
% subplot(2,3,5)
% colormap('jet')
% imagesc(time_axis_TH,1:(size(OI_PSTH.PSTH.TH.Inc,1)),OI_PSTH.PSTH.TH.Inc(I,1:25))
% axis([-2-(0.5*binSize) 3+(0.5*binSize) 0.5 size(OI_PSTH.PSTH.TH.Inc,1)+0.5])
% ylabel('Neuron')
% caxis(axisRange)
% title('Cue orientation')
...
% subplot(2,3,6)
% colormap('jet')
% imagesc(time_axis_cue_bef,1:(size(OI_PSTH.PSTH.cue_bef.Inc,1)),OI_PSTH.PSTH.Cue.Inc(I,1:30))
% axis([-2-(0.5*binSize) 3+(0.5*binSize) 0.5 size(OI_PSTH.PSTH.Cue.Inc,1)+0.5])
% ylabel('Neuron')
% caxis(axisRange)
% title('cueonse')
...
% subplot(2,3,4)
% colormap('jet')
% imagesc(time_axis_TS,1:(size(All_PSTH.PSTH.TS.Inc(VAR_SDixOIMatched),2)),All_PSTH.PSTH.TS.Inc(VAR_SDixOIMatched(I),1:45))
% axis([-2-(0.5*binSize) 7+(0.5*binSize) 0.5 size(All_PSTH.PSTH.TS.Inc(VAR_SDixOIMatched),2)+0.5])
% ylabel('Neuron')
% caxis(axisRange)
% title('Trial start')
...
% subplot(2,3,5)
% colormap('jet')
% imagesc(time_axis_TH,1:(size(All_PSTH.PSTH.TH.Inc(VAR_SDixOIMatched),2)),All_PSTH.PSTH.TH.Inc(VAR_SDixOIMatched(I),1:25))
% axis([-2-(0.5*binSize) 3+(0.5*binSize) 0.5 size(All_PSTH.PSTH.TH.Inc(VAR_SDixOIMatched),2)+0.5])
% ylabel('Neuron')
% caxis(axisRange)
% title('Cue orientation')
...
% subplot(2,3,6)
% colormap('jet')
% imagesc(time_axis_cue_bef,1:(size(All_PSTH.PSTH.cue_bef.Inc(VAR_SDixOIMatched),2)),All_PSTH.PSTH.cue_bef.Inc(VAR_SDixOIMatched(I),1:30))
% axis([-2-(0.5*binSize) 4+(0.5*binSize) 0.5 size(All_PSTH.PSTH.cue_bef.Inc(VAR_SDixOIMatched),2)+0.5])
% ylabel('Neuron')
% caxis(axisRange)
% title('cueonse')
...
title('Proportion of Cor-Inc modulated neurons')
